...
impl<'a> Parser<'a> {
    ...
    fn parse_type(&mut self) -> Type {
        ...
        self.skip_attribute();
        while matches!(self.current().kind, TokenKind::Inline | TokenKind::Noreturn | TokenKind::Register) {
            self.advance();
        }
        self.skip_attribute();
