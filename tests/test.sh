...
assert 3 'int main() { double a = 3.14; return (int)a; }'
assert 4 'int main() { double a = 2.5; double b = 1.5; return (int)(a + b); }'
assert 3 'int main() { float a = 3.14; return (int)a; }'
assert 6 'int main() { double a = 2.5; double b = 3.5; return (int)(a + b); }'
assert 1 'int main() { double a = 3.5; double b = 2.5; return (int)(a - b); }'
assert 6 'int main() { double a = 2.0; double b = 3.0; return (int)(a * b); }'
assert 2 'int main() { double a = 6.0; double b = 3.0; return (int)(a / b); }'
assert 3 'int main() { float a = 1.5; float b = 1.5; return (int)(a + b); }'
assert 4 'int main() { return sizeof(float); }'
assert 8 'int main() { return sizeof(double); }'
assert 5 'int main() { int a = 5; double b = a; return (int)b; }'
assert 1 'int main() { double a = 1.5; double b = 1.5; return a == b; }'
assert 0 'int main() { double a = 1.5; double b = 2.5; return a == b; }'
assert 1 'int main() { double a = 1.0; double b = 2.0; return a < b; }'
assert 0 'int main() { double a = 2.0; double b = 1.0; return a < b; }'
assert 1 'int main() { double a = 2.0; double b = 2.0; return a >= b; }'
...
assert 5 'int main() { register int a = 5; return a; }'
assert 10 'int main() { register int i; i = 10; return i; }'
...
assert 1 '_Static_assert(1, "ok"); int main() { return 1; }'
...
# Step 14.17: void pointer arithmetic and void* declarations
...
assert 10 'struct A; struct B; typedef struct A *APtr; typedef struct B *BPtr; struct A { int x; }; struct B { int y; int z; }; int main() { struct A a; a.x = 10; APtr p = &a; return p->x; }'
